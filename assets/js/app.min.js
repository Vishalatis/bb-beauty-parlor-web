...
! function(e, t) {
    ...
    function z(e, t, i, n, o) {
        if ("string" == typeof t && e) {
            ...
            if (c) c.oneOff = c.oneOff && o;
                        ...
                        return function n(o) {
                            for (var s = e.querySelectorAll(t), r = o.target; r && r !== this; r = r.parentNode)
                                for (var a = s.length; a--;)
                                    if (s[a] === r) return o.delegateTarget = r, n.oneOff && j.off(e, o.type, i), i.apply(r, [o]);
                            return null
                        }
                    }(e, i, n) : function(e, t) {
                        return function i(n) {
                ...
                f.delegationSelector = r ? i : null, f.originalHandler = a, f.oneOff = o, f.uidEvent = h, u[h] = f, e.addEventListener(l, f, r)
            }
        }
    }
    ...
    var j = {
            ...
            off: function(e, t, i, n) {
                if ("string" == typeof t && e) {
                    var o = P(t, i, n),
                        ...
                        u = t.startsWith(".");
                    if (void 0 === r) {
                        u && Object.keys(d).forEach((function(i) {
                            ! function(e, t, i, n) {
                                var o = t[i] || {};
            ...
            trigger: function(e, t, i) {
                ...
                var n, o = y(),
                    ...
                    u = !1,
                    c = null;
                return r && o && (n = o.Event(t, i), o(e).trigger(n), l = !n.isPropagationStopped(), d = !n.isImmediatePropagationStopped(), u = n.isDefaultPrevented()), a ? (c = document.createEvent("HTMLEvents")).initEvent(s, l, !0) : c = new CustomEvent(t, {
                    bubbles: l,
                    cancelable: !0
                ...
                })), u && c.preventDefault(), d && e.dispatchEvent(c), c.defaultPrevented && void 0 !== n && n.preventDefault(), c
            }
        },
        H = function() {
            function e(e) {
    ...
    j.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', $.handleDismiss(new $)), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[N];
            e.fn[N] = $.jQueryInterface, e.fn[N].Constructor = $, e.fn[N].noConflict = function() {
        ...
        K = function(e) {
            ...
            return s.next = function() {
                ...
                if ("next" === e ? (i = "carousel-item-start", n = "carousel-item-next", o = "left") : (i = "carousel-item-end", n = "carousel-item-prev", o = "right"), l && l.classList.contains("active")) this._isSliding = !1;
                    ...
                    if (this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l), this._activeElement = l, this._element.classList.contains("slide")) {
    ...
    j.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", K.dataApiClickHandler), j.on(window, "load.bs.carousel.data-api", (function() {
        for (var e = q.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++) K.carouselInterface(e[t], T(e[t], "bs.carousel"))
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[U];
        ...
        ee = function(e) {
            function o(t, i) {
                ...
                for (var o = q.find('[data-bs-toggle="collapse"]'), s = 0, r = o.length; s < r; s++) {
                    ...
                    null !== d && u.length && (n._selector = d, n._triggerArray.push(a))
                }
            ...
            return s.toggle = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    ...
                    if (!j.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        ...
                        j.one(this._element, "transitionend", (function() {
                            e._element.classList.remove("collapsing"), e._element.classList.add("collapse", "show"), e._element.style[r] = "", e.setTransitioning(!1), j.trigger(e._element, "shown.bs.collapse")
                ...
                var n = T(e, "bs.collapse"),
                    s = i({}, G, Y.getDataAttributes(e), "object" == typeof t && t ? t : {});
    ...
    j.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', (function(e) {
        ...
        if (e) {
            var t = e.fn[X];
            e.fn[X] = ee.jQueryInterface, e.fn[X].Constructor = ee, e.fn[X].noConflict = function() {
        ...
        fn: function(e) {
            ...
            Object.keys(t.elements).forEach((function(e) {
                var i = t.styles[e] || {},
                    n = t.attributes[e] || {},
                    o = t.elements[e];
                he(o) && de(o) && (Object.assign(o.style, i), Object.keys(n).forEach((function(e) {
                    var t = n[e];
            ...
            return Object.assign(t.elements.popper.style, i.popper), t.elements.arrow && Object.assign(t.elements.arrow.style, i.arrow),
                function() {
                    Object.keys(t.elements).forEach((function(e) {
                        ...
                        he(n) && de(n) && (Object.assign(n.style, s), Object.keys(o).forEach((function(e) {
                            n.removeAttribute(e)
                        })))
                    }))
                }
    ...
    function ke(e) {
        ...
        return i && "body" === de(i) && "static" === ve(i).position ? t : i || function(e) {
            for (var t = _e(e); he(t) && ["html", "body"].indexOf(de(t)) < 0;) {
                var i = ve(t);
    ...
    function Ee(e) {
        ...
        if (l) {
            var v = ke(i);
            v === ue(i) && (v = be(i)), o === te && (m = ie, c -= v.clientHeight - n.height, c *= a ? 1 : -1), o === oe && (p = ne, u -= v.clientWidth - n.width, u *= a ? 1 : -1)
        }
        var y, b = Object.assign({
            position: r
        }, l && Oe);
        return a ? Object.assign(Object.assign({}, b), {}, ((y = {})[m] = f ? "0" : "", y[p] = h ? "0" : "", y.transform = (g.devicePixelRatio || 1) < 2 ? "translate(" + u + "px, " + c + "px)" : "translate3d(" + u + "px, " + c + "px, 0)", y)) : Object.assign(Object.assign({}, b), {}, ((t = {})[m] = f ? c + "px" : "", t[p] = h ? u + "px" : "", t.transform = "", t))
    }
    var Me = {
            name: "computeStyles",
            enabled: !0,
    ...
    function Fe(e, t) {
        void 0 === t && (t = []);
        var i = function e(t) {
                return ["html", "body", "#document"].indexOf(de(t)) >= 0 ? t.ownerDocument.body : he(t) && $e(t) ? t : e(_e(t))
            }(e),
            n = "body" === de(i),
            o = ue(i),
        ...
        var i = t,
            ...
            _ = function(e, t, i) {
                var n = "clippingParents" === t ? function(e) {
                        var t = Fe(_e(e)),
                            i = ["absolute", "fixed"].indexOf(ve(e).position) >= 0 && he(e) ? ke(e) : e;
                        return ce(i) ? t.filter((function(e) {
    ...
    var Ve = {
        ...
        fn: function(e) {
            ...
            if (!t.modifiersData[n]._skip) {
                for (var o = i.mainAxis, s = void 0 === o || o, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, d = i.padding, u = i.boundary, c = i.rootBoundary, h = i.altBoundary, f = i.flipVariations, p = void 0 === f || f, m = i.allowedAutoPlacements, g = t.options.placement, v = pe(g), y = l || (v !== g && p ? function(e) {
                        if ("auto" === pe(e)) return [];
                        var t = Pe(e);
                        return [We(e), t, We(t)]
                    ...
                    }), []), _ = t.rects.reference, w = t.rects.popper, k = new Map, T = !0, S = b[0], x = 0; x < b.length; x++) {
                    var C = b[x],
                        D = pe(C),
                        O = "start" === Ye(C),
                        E = [te, ie].indexOf(D) >= 0,
                    ...
                    var L = Pe(I),
                        P = [];
                    if (s && P.push(A[D] <= 0), a && P.push(A[I] <= 0, A[L] <= 0), P.every((function(e) {
                            return e
                        }))) {
                        S = C, T = !1;
                        break
        ...
        Ze = {
            ...
            fn: function(e) {
                var t = e.state,
                    ...
                    T = t.rects.reference,
                    S = t.rects.popper,
                    x = "function" == typeof m ? m(Object.assign(Object.assign({}, t.rects), {}, {
                        placement: t.placement
                    })) : m,
                    C = {
                        x: 0,
    ...
    function et(e, t, i) {
        ...
        return (a || !a && !i) && (("body" !== de(t) || $e(s)) && (l = (n = t) !== ue(n) && he(n) ? {
            scrollLeft: (o = n).scrollLeft,
            scrollTop: o.scrollTop
        } : He(n)), he(t) ? ((d = je(t)).x += t.clientLeft, d.y += t.clientTop) : s && (d.x = Ne(s))), {
            ...
            var o, r, a = {
                ...
                u = {
                    ...
                    setOptions: function(i) {
                        c(), a.options = Object.assign(Object.assign(Object.assign({}, s), a.options), i), a.scrollParents = {
                            reference: ce(e) ? Fe(e) : e.contextElement ? Fe(e.contextElement) : [],
                            popper: Fe(t)
                        };
    ...
    var ot = nt(),
        st = nt({
            defaultModifiers: [Ie, Ge, Me, fe]
        }),
        rt = nt({
            defaultModifiers: [Ie, Ge, Me, fe, Xe, Ve, Ze, De, Ke]
        }),
        at = Object.freeze({
            __proto__: null,
            popperGenerator: nt,
        ...
        yt = function(e) {
            ...
            return s.toggle = function() {
                ...
                if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                    ...
                    if (!j.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                        if (!this._inNavbar) {
                            ...
                            var i = this._element;
                            "parent" === this._config.reference ? i = e : h(this._config.reference) && (i = this._config.reference, void 0 !== this._config.reference.jquery && (i = this._config.reference[0])), this._popper = rt(i, this._menu, this._getPopperConfig())
                        }
                        var n;
                ...
                return e = i({}, this.constructor.Default, Y.getDataAttributes(this._element), e), p(lt, e, this.constructor.DefaultType), e
                ...
                if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                    for (var t = q.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                        ...
                        if (e && "click" === e.type && (a.clickEvent = e), r) {
                            var l, d = r._menu;
                            if (t[i].classList.contains("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && d.contains(e.target) || j.trigger(s, "hide.bs.dropdown", a).defaultPrevented)) "ontouchstart" in document.documentElement && (l = []).concat.apply(l, document.body.children).forEach((function(e) {
                                return j.off(e, "mouseover", null, (function() {}))
                            })), t[i].setAttribute("aria-expanded", "false"), r._popper && r._popper.destroy(), d.classList.remove("show"), t[i].classList.remove("show"), j.trigger(s, "hidden.bs.dropdown", a)
                        }
                    }
                ...
                if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !dt.test(e.key)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))) {
                    ...
                    if ("Escape" === e.key) return (this.matches('[data-bs-toggle="dropdown"]') ? this : q.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void o.clearMenus();
                    if (i && "Space" !== e.key) {
            ...
            return s.toggle = function(e) {
                ...
                return this.each((function() {
                    var n = T(this, "bs.modal"),
                        s = i({}, bt, Y.getDataAttributes(this), "object" == typeof e && e ? e : {});
        ...
        Lt = function(e) {
            ...
            return s.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    k(o, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || d.appendChild(o), j.trigger(this._element, this.constructor.Event.INSERTED), this._popper = rt(this._element, o, this._getPopperConfig(l)), o.classList.add("show");
                    var c, h, p = "function" == typeof this.config.customClass ? this.config.customClass() : this.config.customClass;
                    p && (c = o.classList).add.apply(c, p.split(" ")), "ontouchstart" in document.documentElement && (h = []).concat.apply(h, document.body.children).forEach((function(e) {
                ...
                if (null !== e) return "object" == typeof t && h(t) ? (t.jquery && (t = t[0]), void(this.config.html ? t.parentNode !== e && (e.innerHTML = "", e.appendChild(t)) : e.textContent = t.textContent)) : void(this.config.html ? (this.config.sanitize && (t = xt(t, this.config.allowList, this.config.sanitizeFn)), e.innerHTML = t) : e.textContent = t)
            }, s.getTitle = function() {
                ...
                return Object.keys(t).forEach((function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), p(Ct, e, this.constructor.DefaultType), e.sanitize && (e.template = xt(e.template, e.allowList, e.sanitizeFn)), e
    ...
    b((function() {
        ...
        if (e) {
            var t = e.fn[Pt];
            e.fn[Pt] = Nt.jQueryInterface, e.fn[Pt].Constructor = Nt, e.fn[Pt].noConflict = function() {
    ...
    var $t = "scrollspy",
        ...
        Rt = function(e) {
            ...
            return s.refresh = function() {
                ...
                if ("string" != typeof(e = i({}, Ft, "object" == typeof e && e ? e : {})).target && h(e.target)) {
                    var t = e.target.id;
    ...
    j.on(window, "load.bs.scrollspy.data-api", (function() {
        ...
        if (e) {
            var t = e.fn[$t];
            e.fn[$t] = Rt.jQueryInterface, e.fn[$t].Constructor = Rt, e.fn[$t].noConflict = function() {
    ...
    var Yt = function(e) {
        ...
        return o.show = function() {
            ...
            var n = this,
                o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? q.children(t, ".active") : q.find(":scope > li > .active", t))[0],
    ...
    var qt = {
        ...
        Vt = function(e) {
            ...
            return s.show = function() {
                ...
                return e = i({}, Ut, Y.getDataAttributes(this._element), "object" == typeof e && e ? e : {}), p("toast", e, this.constructor.DefaultType), e
            }, s._setListeners = function() {
                var e = this;
...
function(e, t) {
    ...
    function i(i, s, a) {
        (a = a || t || e.jQuery) && (s.prototype.option || (s.prototype.option = function(e) {
            ...
            if ("string" != typeof e) return c = e, this.each((function(e, t) {
                var n = a.data(t, i);
                n ? (n.option(c), n._init()) : (n = new s(t, c), a.data(t, i, n))
            })), this;
            var t, n, l, d, u, c, h = o.call(arguments, 1);
            return l = h, u = "$()." + i + '("' + (n = e) + '")', (t = this).each((function(e, t) {
                var o = a.data(t, i);
                if (o) {
                    var s = o[n];
                    if (s && "_" != n.charAt(0)) {
...
function(e, t) {
    ...
    return function n(a) {
        if (function() {
            ...
            for (var u = d.isBorderBox = "border-box" == l.boxSizing, c = 0; c < s; c++) {
                var h = o[c],
                    f = l[h],
                    p = parseFloat(f);
                d[h] = isNaN(p) ? 0 : p
    ...
    return i.htmlInit = function(t, n) {
        i.docReady((function() {
            ...
            d.forEach((function(e) {
                var i, s = e.getAttribute(r) || e.getAttribute(u);
                try {
                    i = s && JSON.parse(s)
                } catch (i) {
...
function(e) {
    ...
    e.cleanData = (t = e.cleanData, function(i) {
        ...
        _classes: function(t) {
            ...
            function o(o, s) {
                for (var r, a = 0; a < o.length; a++) r = n.classesElementLookup[o[a]] || e(), r = t.add ? e(e.unique(r.get().concat(t.element.get()))) : e(r.not(t.element).get()), n.classesElementLookup[o[a]] = r, i.push(o[a]), s && t.classes[o[a]] && i.push(t.classes[o[a]])
            }
            return t = e.extend({
        ...
        _on: function(t, i, n) {
            ...
            "boolean" != typeof t && (n = i, i = t, t = !1), n ? (i = o = e(i), this.bindings = this.bindings.add(i)) : (n = i, i = this.element, o = this.widget()), e.each(n, (function(n, r) {
                ...
                var l;
                "string" != typeof r && (a.guid = r.guid = r.guid || a.guid || e.guid++), n = (l = n.match(/^([\w:-]*)\s*(.*)$/))[1] + s.eventNamespace, (l = l[2]) ? o.on(n, l, a) : i.on(n, a)
            }))
        },
        _off: function(t, i) {
    ...
    e(document).on("mouseup", (function() {
        ...
        _createHandles: function() {
            ...
            for (n.length > s && (n.slice(s).remove(), n = n.slice(0, s)), t = n.length; t < s; t++) o.push("<span tabindex='0'></span>");
        ...
        _mouseCapture: function(t) {
            ...
            return !d.disabled && (this.elementSize = {
                ...
                (r < n || n === r && (t === l._lastChangedValue || l.values(t) === d.min)) && (n = r, o = e(this), s = t)
            })), !1 !== this._start(t, s) && (this._mouseSliding = !0, this._handleIndex = s, this._addClass(o, null, "ui-state-active"), o.trigger("focus"), r = o.offset(), a = !e(t.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = a ? {
                left: 0,
                top: 0
            } : {
        ...
        _slide: function(e, t, i) {
            var n, o = this.value(),
                s = this.values();
            this._hasMultipleValues() && (n = this.values(t ? 0 : 1), o = this.values(t), 2 === this.options.values.length && !0 === this.options.range && (i = 0 === t ? Math.min(n, i) : Math.max(n, i)), s[t] = i), i !== o && !1 !== this._trigger("slide", e, this._uiHash(t, i, s)) && (this._hasMultipleValues() ? this.values(t, i) : this.value(i))
        },
        _stop: function(e, t) {
        ...
        values: function(t, i) {
            ...
            for (n = this.options.values, o = t, s = 0; s < n.length; s += 1) n[s] = this._trimAlignValue(o[s]), this._change(null, s);
            this._refreshValue()
        },
        _setOption: function(t, i) {
            var n, o = 0;
            switch ("range" === t && !0 === this.options.range && ("min" === i ? (this.options.value = this._values(0), this.options.values = null) : "max" === i && (this.options.value = this._values(this.options.values.length - 1), this.options.values = null)), e.isArray(this.options.values) && (o = this.options.values.length), this._super(t, i), t) {
                case "orientation":
        ...
        _refreshValue: function() {
            ...
            this._hasMultipleValues() ? this.handles.each((function(n) {
                i = (l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin()) * 100, u["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", e(this).stop(1, 1)[d ? "animate" : "css"](u, a.animate), !0 === l.options.range && ("horizontal" === l.orientation ? (0 === n && l.range.stop(1, 1)[d ? "animate" : "css"]({
                    left: i + "%"
            ...
            })) : (n = this.value(), o = this._valueMin(), s = this._valueMax(), i = s !== o ? (n - o) / (s - o) * 100 : 0, u["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[d ? "animate" : "css"](u, a.animate), "min" === r && "horizontal" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                width: i + "%"
...
function() {
    ...
    e = function(e, t) {
        ...
        parseDate: function(t, i) {
            var n, o, s, r, a, l, d, u, c, h, f = this,
                p = !1,
                m = !1,
                g = f.dateSettings,
                v = {
            ...
            for (o = t.replace(f.separators, "\0").split("\0"), s = 0; s < o.length; s++) switch (r = o[s], a = parseInt(r), n[s]) {
                ...
                case "Y":
                    if (!a) return null;
                    c = r.length, v.year = 2 === c ? parseInt((a < 70 ? "20" : "19") + r) : a, p = !0;
                    break;
                case "m":
                case "n":
                case "M":
                ...
                case "g":
                case "h":
                    if (h = o[d = -1 < n.indexOf("a") ? n.indexOf("a") : -1 < n.indexOf("A") ? n.indexOf("A") : -1], -1 < d) u = e(h, g.meridiem[0]) ? 0 : e(h, g.meridiem[1]) ? 12 : -1, 1 <= a && a <= 12 && -1 < u ? v.hour = a + u - 1 : 0 <= a && a <= 23 && (v.hour = a);
                    else {
        ...
        guessDate: function(e, t) {
            ...
            for (o = 0; o < l.length; o++) {
                if (c = 2, r = l[o], a = parseInt(r.substr(0, 2)), isNaN(a)) return null;
                switch (o) {
                    case 0:
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        if (n = u.getFullYear(), c = (i = r.length) < 4 ? i : 4, !(n = parseInt(i < 4 ? n.toString().substr(0, 4 - i) + r : r.substr(0, 4)))) return null;
                        u.setFullYear(n);
                        break;
                    case 3:
                        u.setHours(a);
    ...
    e.extend(e.datetimepicker, l), r(), window.getComputedStyle || (window.getComputedStyle = function(e) {
        ...
        return this.each((function() {
            ...
            "hide" !== i ? (e(this).hasClass("xdsoft_scroller_box") || (n = l.children().eq(0), o = l[0].clientHeight, s = n[0].offsetHeight, r = e('<div class="xdsoft_scrollbar"></div>'), a = e('<div class="xdsoft_scroller"></div>'), r.append(a), l.addClass("xdsoft_scroller_box").append(r), v = function(e) {
                var t = d(e).y - h + g;
                t < 0 && (t = 0), t + a[0].offsetHeight > p && (t = p - a[0].offsetHeight), l.trigger("scroll_element.xdsoft_scroller", [u ? t / u : 0])
            }, a.on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", (function(n) {
                o || l.trigger("resize_scroll.xdsoft_scroller", [i]), h = d(n).y, g = parseInt(a.css("margin-top"), 10), p = r[0].offsetHeight, "mousedown" === n.type || "touchstart" === n.type ? (t.ownerDocument && e(t.ownerDocument.body).addClass("xdsoft_noselect"), e([t.ownerDocument.body, t.contentWindow]).on("touchend mouseup.xdsoft_scroller", (function i() {
                ...
                o || l.trigger("resize_scroll.xdsoft_scroller", [t, !0]), t = 1 < t ? 1 : t < 0 || isNaN(t) ? 0 : t, a.css("margin-top", u * t), setTimeout((function() {
                    n.css("marginTop", -parseInt((n[0].offsetHeight - o) * t, 10))
                }), 10)
            })).on("resize_scroll.xdsoft_scroller", (function(e, t, i) {
                var d, c;
                o = l[0].clientHeight, s = n[0].offsetHeight, c = (d = o / s) * r[0].offsetHeight, 1 < d ? a.hide() : (a.show(), a.css("height", parseInt(10 < c ? c : 10, 10)), u = r[0].offsetHeight - a[0].offsetHeight, !0 !== i && l.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(n.css("marginTop"), 10)) / (s - o)]))
                ...
                if (c) {
                    e.preventDefault();
                    var t = d(e);
                    l.trigger("scroll_element.xdsoft_scroller", [(f - (t.y - c.y)) / (s - o)])
                }
        ...
        var r, a, l = this,
            ...
            T = 89,
            S = !1,
            x = e.isPlainObject(n) || !n ? e.extend(!0, {}, t, n) : e.extend(!0, {}, t),
            C = 0;
        return r = function(t) {
            ...
            x.id && O.attr("id", x.id), x.style && O.attr("style", x.style), x.weeks && O.addClass("xdsoft_showweeks"), x.rtl && O.addClass("xdsoft_rtl"), O.addClass("xdsoft_" + x.theme), O.addClass(x.className), A.find(".xdsoft_month span").after(j), A.find(".xdsoft_year span").after(H), A.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", (function(t) {
                ...
                return o.xdsoftScroller(x, r / (o.children()[0].offsetHeight - o[0].clientHeight)), t.stopPropagation(), !1
            }));
            var F = function(e) {
            ...
            function R(n) {
                ...
                n.mask && t.off("keydown.xdsoft"), !0 === n.mask && (i.formatMask ? n.mask = i.formatMask(n.format) : n.mask = n.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === e.type(n.mask) && (o(n.mask, t.val()) || (t.val(n.mask.replace(/[0-9]/g, "_")), s(t[0], 0)), t.on("paste.xdsoft", (function(i) {
                    ...
                    if (48 <= l && l <= 57 || 96 <= l && l <= 105 || 8 === l || 46 === l) {
                        for (r = 8 === l || 46 === l ? "_" : String.fromCharCode(96 <= l && l <= 105 ? l - 48 : l), 8 === l && u && !C && (u -= 1);;) {
                        ...
                        for (u += 8 === l ? 0 : 1;
                            /[^0-9_]/.test(n.mask.substr(u, 1)) && u < n.mask.length && 0 < u;) u += 8 === l ? 0 : 1;
                        o(n.mask, a) ? (this.value = a, s(this, u)) : "" === e.trim(a) ? this.value = n.mask.replace(/[0-9]/g, "_") : t.trigger("error_input.xdsoft")
                    } else if (-1 !== [b, _, w, k, T].indexOf(l) && S || -1 !== [h, p, g, f, m, y, d, v, c].indexOf(l)) return !0;
                    return i.preventDefault(), !1
                })))
            }
            A.find(".xdsoft_select").xdsoftScroller(x).on("touchstart mousedown.xdsoft", (function(e) {
                var t = e.originalEvent;
                this.touchMoved = !1, this.touchStartPosition = t.touches ? t.touches[0] : t, e.stopPropagation(), e.preventDefault()
            })).on("touchmove", ".xdsoft_option", F).on("touchend mousedown.xdsoft", ".xdsoft_option", (function() {
                if (!this.touchMoved) {
                    void 0 !== C.currentTime && null !== C.currentTime || (C.currentTime = C.now());
                    var t = C.currentTime.getFullYear();
                    C && C.currentTime && C.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")), e(this).parent().parent().hide(), O.trigger("xchange.xdsoft"), x.onChangeMonth && e.isFunction(x.onChangeMonth) && x.onChangeMonth.call(O, C.currentTime, O.data("input")), t !== C.currentTime.getFullYear() && e.isFunction(x.onChangeYear) && x.onChangeYear.call(O, C.currentTime, O.data("input"))
                }
            })), O.getValue = function() {
                ...
                x = e.extend(!0, {}, x, n), n.allowTimes && e.isArray(n.allowTimes) && n.allowTimes.length && (x.allowTimes = e.extend(!0, [], n.allowTimes)), n.weekends && e.isArray(n.weekends) && n.weekends.length && (x.weekends = e.extend(!0, [], n.weekends)), n.allowDates && e.isArray(n.allowDates) && n.allowDates.length && (x.allowDates = e.extend(!0, [], n.allowDates)), n.allowDateRe && "[object String]" === Object.prototype.toString.call(n.allowDateRe) && (x.allowDateRe = new RegExp(n.allowDateRe)), n.highlightedDates && e.isArray(n.highlightedDates) && n.highlightedDates.length && (e.each(n.highlightedDates, (function(t, n) {
                    ...
                    if (x.allowBlank && (!e.trim(e(this).val()).length || "string" == typeof x.mask && e.trim(e(this).val()) === x.mask.replace(/[0-9]/g, "_"))) e(this).val(null), O.data("xdsoft_datetime").empty();
                        ...
                        if (t) e(this).val(i.formatDate(t, x.format));
                            ...
                            !x.datepicker && x.timepicker && 0 <= n && n < 24 && 0 <= o && o < 60 ? e(this).val([n, o].map((function(e) {
                                return 9 < e ? e : "0" + e
                            })).join(":")) : e(this).val(i.formatDate(C.now(), x.format))
                        }
                        O.data("xdsoft_datetime").setCurrentTime(e(this).val())
                    }
                    O.trigger("changedatetime.xdsoft"), O.trigger("close.xdsoft")
                })), x.dayOfWeekStartPrev = 0 === x.dayOfWeekStart ? 6 : x.dayOfWeekStart - 1, O.trigger("xchange.xdsoft").trigger("afterOpen.xdsoft")
            }, O.data("options", x).on("touchstart mousedown.xdsoft", (function(e) {
                return e.stopPropagation(), e.preventDefault(), H.hide(), j.hide(), !1
            })), P.append(z), P.xdsoftScroller(x), O.on("afterOpen.xdsoft", (function() {
                P.xdsoftScroller(x)
            })), O.append(M).append(L), !0 !== x.withoutCopyright && O.append(E), M.append(A).append(I).append(W), x.insideParent ? e(t).parent().append(O) : e(x.parentID).append(O), C = new function() {
                var t = this;
                t.now = function(e) {
                    var i, n, o = new Date;
                    return !e && x.defaultDate && (i = t.strToDateTime(x.defaultDate), o.setFullYear(i.getFullYear()), o.setMonth(i.getMonth()), o.setDate(i.getDate())), o.setFullYear(o.getFullYear()), !e && x.defaultTime && (n = t.strtotime(x.defaultTime), o.setHours(n.getHours()), o.setMinutes(n.getMinutes()), o.setSeconds(n.getSeconds()), o.setMilliseconds(n.getMilliseconds())), o
                }, t.isValidDate = function(e) {
                    return "[object Date]" === Object.prototype.toString.call(e) && !isNaN(e.getTime())
                }, t.setCurrentTime = function(e, i) {
                    "string" == typeof e ? t.currentTime = t.strToDateTime(e) : t.isValidDate(e) ? t.currentTime = e : e || i || !x.allowBlank || x.inline ? t.currentTime = t.now() : t.currentTime = null, O.trigger("xchange.xdsoft")
                }, t.empty = function() {
                    t.currentTime = null
                    ...
                    return 12 === n && (t.currentTime.setFullYear(t.currentTime.getFullYear() + 1), n = 0), i = t.currentTime.getFullYear(), t.currentTime.setDate(Math.min(new Date(t.currentTime.getFullYear(), n + 1, 0).getDate(), t.currentTime.getDate())), t.currentTime.setMonth(n), x.onChangeMonth && e.isFunction(x.onChangeMonth) && x.onChangeMonth.call(O, C.currentTime, O.data("input")), i !== t.currentTime.getFullYear() && e.isFunction(x.onChangeYear) && x.onChangeYear.call(O, C.currentTime, O.data("input")), O.trigger("xchange.xdsoft"), n
                }, t.prevMonth = function() {
                    void 0 !== t.currentTime && null !== t.currentTime || (t.currentTime = t.now());
                    var i = t.currentTime.getMonth() - 1;
                    return -1 === i && (t.currentTime.setFullYear(t.currentTime.getFullYear() - 1), i = 11), t.currentTime.setDate(Math.min(new Date(t.currentTime.getFullYear(), i + 1, 0).getDate(), t.currentTime.getDate())), t.currentTime.setMonth(i), x.onChangeMonth && e.isFunction(x.onChangeMonth) && x.onChangeMonth.call(O, C.currentTime, O.data("input")), O.trigger("xchange.xdsoft"), i
                    ...
                    var n, o, s = [];
                    return e && e instanceof Date && t.isValidDate(e) ? e : ((s = /^([+-]{1})(.*)$/.exec(e)) && (s[2] = i.parseDate(s[2], x.formatDate)), o = s && s[2] ? (n = s[2].getTime() - 6e4 * s[2].getTimezoneOffset(), new Date(t.now(!0).getTime() + parseInt(s[1] + "1", 10) * n)) : e ? i.parseDate(e, x.format) : t.now(), t.isValidDate(o) || (o = t.now()), o)
                    ...
                    var e = x.format;
                    return x.yearOffset && (e = (e = e.replace("Y", t.currentTime.getFullYear() + x.yearOffset)).replace("y", String(t.currentTime.getFullYear() + x.yearOffset).substring(2, 4))), i.formatDate(t.currentTime, e)
                }, t.currentTime = this.now()
            }, W.on("touchend click", (function(e) {
                e.preventDefault(), O.data("changed", !0), C.setCurrentTime(B()), t.val(C.str()), O.trigger("close.xdsoft")
                ...
                n = new Date(n.getFullYear(), n.getMonth(), n.getDate()), e = C.strToDate(x.minDate), n < (e = new Date(e.getFullYear(), e.getMonth(), e.getDate())) || (i = C.strToDate(x.maxDate), (i = new Date(i.getFullYear(), i.getMonth(), i.getDate())) < n || (t.val(C.str()), t.trigger("change"), O.trigger("close.xdsoft")))
            })), A.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", (function() {
                var t = e(this),
                    i = 0,
                    n = !1;
                ! function e(o) {
                    t.hasClass(x.next) ? C.nextMonth() : t.hasClass(x.prev) && C.prevMonth(), x.monthChangeSpinner && (n || (i = setTimeout(e, o || 100)))
                }(500), e([x.ownerDocument.body, x.contentWindow]).on("touchend mouseup.xdsoft", (function t() {
                    clearTimeout(i), n = !0, e([x.ownerDocument.body, x.contentWindow]).off("touchend mouseup.xdsoft", t)
                }))
                ...
                ! function e(s) {
                    ...
                    t.hasClass(x.next) && a - r - x.timeHeightInTimePicker >= l ? z.css("marginTop", "-" + (l + x.timeHeightInTimePicker) + "px") : t.hasClass(x.prev) && 0 <= l - x.timeHeightInTimePicker && z.css("marginTop", "-" + (l - x.timeHeightInTimePicker) + "px"), P.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(z[0].style.marginTop, 10) / (a - r))]), o = 10 < o ? 10 : o - 10, n || (i = setTimeout(e, s || o))
                }(500), e([x.ownerDocument.body, x.contentWindow]).on("touchend mouseup.xdsoft", (function t() {
                    clearTimeout(i), n = !0, e([x.ownerDocument.body, x.contentWindow]).off("touchend mouseup.xdsoft", t)
                }))
                ...
                clearTimeout(s), s = setTimeout((function() {
                    void 0 !== C.currentTime && null !== C.currentTime || (C.currentTime = C.now());
                    for (var s, r, a, l, d, u, c, h, f, p, m = "", g = new Date(C.currentTime.getFullYear(), C.currentTime.getMonth(), 1, 12, 0, 0), v = 0, y = C.now(), b = !1, _ = !1, w = !1, k = !1, T = [], S = !0, D = ""; g.getDay() !== x.dayOfWeekStart;) g.setDate(g.getDate() - 1);
                    for (m += "<table><thead><tr>", x.weeks && (m += "<th></th>"), s = 0; s < 7; s += 1) m += "<th>" + x.i18n[o].dayOfWeekShort[(s + x.dayOfWeekStart) % 7] + "</th>";
                    for (m += "</tr></thead>", m += "<tbody>", !1 !== x.maxDate && (b = C.strToDate(x.maxDate), b = new Date(b.getFullYear(), b.getMonth(), b.getDate(), 23, 59, 59, 999)), !1 !== x.minDate && (_ = C.strToDate(x.minDate), _ = new Date(_.getFullYear(), _.getMonth(), _.getDate())), !1 !== x.minDateTime && (w = C.strToDate(x.minDateTime), w = new Date(w.getFullYear(), w.getMonth(), w.getDate(), w.getHours(), w.getMinutes(), w.getSeconds())), !1 !== x.maxDateTime && (k = C.strToDate(x.maxDateTime), k = new Date(k.getFullYear(), k.getMonth(), k.getDate(), k.getHours(), k.getMinutes(), k.getSeconds())), !1 !== k && (p = 31 * (12 * k.getFullYear() + k.getMonth()) + k.getDate()); v < C.currentTime.countDaysInMonth() || g.getDay() !== x.dayOfWeekStart || C.currentTime.getMonth() === g.getMonth();) {
                    ...
                    var P = 1440;
                    if (!1 !== x.maxTime && (L = C.strtotime(x.maxTime), P = 60 * L.getHours() + L.getMinutes()), !1 !== x.minDateTime && (L = C.strToDateTime(x.minDateTime), i.formatDate(C.currentTime, x.formatDate) === i.formatDate(L, x.formatDate))) {
                        var W = 60 * L.getHours() + L.getMinutes();
                        M < W && (M = W)
                    }
                    if (!1 !== x.maxDateTime && (L = C.strToDateTime(x.maxDateTime), i.formatDate(C.currentTime, x.formatDate) === i.formatDate(L, x.formatDate) && (W = 60 * L.getHours() + L.getMinutes()) < P && (P = W)), h = function(n, o) {
                            var s, r = C.now(),
                                a = x.allowTimes && e.isArray(x.allowTimes) && x.allowTimes.length;
                            r.setHours(n), n = parseInt(r.getHours(), 10), r.setMinutes(o), o = parseInt(r.getMinutes(), 10), T = [];
                            var l = 60 * n + o;
                            (t.is("[disabled]") || P <= l || l < M) && T.push("xdsoft_disabled"), (s = new Date(C.currentTime)).setHours(parseInt(C.currentTime.getHours(), 10)), a || s.setMinutes(Math[x.roundTime](C.currentTime.getMinutes() / x.step) * x.step), (x.initTime || x.defaultSelect || O.data("changed")) && s.getHours() === parseInt(n, 10) && (!a && 59 < x.step || s.getMinutes() === parseInt(o, 10)) && (x.defaultSelect || O.data("changed") ? T.push("xdsoft_current") : x.initTime && T.push("xdsoft_init_time")), parseInt(y.getHours(), 10) === parseInt(n, 10) && parseInt(y.getMinutes(), 10) === parseInt(o, 10) && T.push("xdsoft_today"), D += '<div class="xdsoft_time ' + T.join(" ") + '" data-hour="' + n + '" data-minute="' + o + '">' + i.formatDate(r, x.formatTime) + "</div>"
                        }, x.allowTimes && e.isArray(x.allowTimes) && x.allowTimes.length)
                        for (v = 0; v < x.allowTimes.length; v += 1) h(C.strtotime(x.allowTimes[v]).getHours(), W = C.strtotime(x.allowTimes[v]).getMinutes());
                    else
                        for (s = v = 0; v < (x.hours12 ? 12 : 24); v += 1)
                            for (s = 0; s < 60; s += x.step) {
                                var N = 60 * v + s;
                                N < M || P <= N || h((v < 10 ? "0" : "") + v, W = (s < 10 ? "0" : "") + s)
                            }
                    for (z.html(D), n = "", v = parseInt(x.yearStart, 10); v <= parseInt(x.yearEnd, 10); v += 1) n += '<div class="xdsoft_option ' + (C.currentTime.getFullYear() === v ? "xdsoft_current" : "") + '" data-value="' + v + '">' + (v + x.yearOffset) + "</div>";
                    for (H.children().eq(0).html(n), v = parseInt(x.monthStart, 10), n = ""; v <= parseInt(x.monthEnd, 10); v += 1) n += '<div class="xdsoft_option ' + (C.currentTime.getMonth() === v ? "xdsoft_current" : "") + '" data-value="' + v + '">' + x.i18n[o].months[v] + "</div>";
                    j.children().eq(0).html(n), e(O).trigger("generate.xdsoft")
                }), 10), r.stopPropagation()
            })).on("afterOpen.xdsoft", (function() {
                var e, t, i, n;
                x.timepicker && (z.find(".xdsoft_current").length ? e = ".xdsoft_current" : z.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"), e ? (t = P[0].clientHeight, (i = z[0].offsetHeight) - t < (n = z.find(e).index() * x.timeHeightInTimePicker + 1) && (n = i - t), P.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (i - t)])) : P.trigger("scroll_element.xdsoft_scroller", [0]))
                ...
                this.touchMoved = !1
            })).on("touchmove", "div", F).on("touchend click.xdsoft", "div", (function(t) {
                if (!this.touchMoved) {
                    t.stopPropagation();
                    var i = e(this),
                        n = C.currentTime;
                ...
                return !x.scrollMonth || (e.deltaY < 0 ? C.nextMonth() : C.prevMonth(), !1)
            })), t.on("mousewheel.xdsoft", (function(e) {
                return !x.scrollInput || (!x.datepicker && x.timepicker ? (0 <= (a = z.find(".xdsoft_current").length ? z.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY && a + e.deltaY < z.children().length && (a += e.deltaY), z.children().eq(a).length && z.children().eq(a).trigger("mousedown"), !1) : x.datepicker && !x.timepicker ? (M.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), t.val && t.val(C.str()), O.trigger("changedatetime.xdsoft"), !1) : void 0)
            })), O.on("changedatetime.xdsoft", (function(t) {
                if (x.onChangeDateTime && e.isFunction(x.onChangeDateTime)) {
                    var i = O.data("input");
                    x.onChangeDateTime.call(O, C.currentTime, i, t), delete x.value, i.trigger("change")
                }
            })).on("generate.xdsoft", (function() {
                x.onGenerate && e.isFunction(x.onGenerate) && x.onGenerate.call(O, C.currentTime, O.data("input")), N && (O.trigger("afterOpen.xdsoft"), N = !1)
                ...
                if (t = (l = O.data("input")).offset(), i = l[0], u = "top", n = t.top + i.offsetHeight - 1, o = t.left, s = "absolute", d = e(x.contentWindow).width(), h = e(x.contentWindow).height(), f = e(x.contentWindow).scrollTop(), x.ownerDocument.documentElement.clientWidth - t.left < M.parent().outerWidth(!0)) {
                    var p = M.parent().outerWidth(!0) - i.offsetWidth;
                    o -= p
                }
                "rtl" === l.parent().css("direction") && (o -= O.outerWidth() - l.outerWidth()), x.fixed ? (n -= f, o -= e(x.contentWindow).scrollLeft(), s = "fixed") : (a = !1, D(i, (function(e) {
                    return null !== e && ("fixed" === x.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(a = !0) : void 0)
                })), a && !x.insideParent ? (s = "fixed", n + O.outerHeight() > h + f ? (u = "bottom", n = h + f - t.top) : n -= f) : n + O[0].offsetHeight > h + f && (n = t.top - O[0].offsetHeight + 1), n < 0 && (n = 0), o + i.offsetWidth > d && (o = d - i.offsetWidth)), r = O[0], D(r, (function(e) {
                    if ("relative" === x.contentWindow.getComputedStyle(e).getPropertyValue("position") && d >= e.offsetWidth) return o -= (d - e.offsetWidth) / 2, !1
                })), c = {
                    position: s,
                    left: x.insideParent ? i.offsetLeft : o,
                    top: "",
                    bottom: ""
                }, x.insideParent ? c[u] = i.offsetTop + i.offsetHeight : c[u] = n, O.css(c)
            }, O.on("open.xdsoft", (function(t) {
                var i = !0;
                x.onShow && e.isFunction(x.onShow) && (i = x.onShow.call(O, C.currentTime, O.data("input"), t)), !1 !== i && (O.show(), l(), e(x.contentWindow).off("resize.xdsoft", l).on("resize.xdsoft", l), x.closeOnWithoutClick && e([x.ownerDocument.body, x.contentWindow]).on("touchstart mousedown.xdsoft", (function t() {
                    O.trigger("close.xdsoft"), e([x.ownerDocument.body, x.contentWindow]).off("touchstart mousedown.xdsoft", t)
                })))
            })).on("close.xdsoft", (function(t) {
                var i = !0;
                A.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(), x.onClose && e.isFunction(x.onClose) && (i = x.onClose.call(O, C.currentTime, O.data("input"), t)), !1 === i || x.opened || x.inline || O.hide(), t.stopPropagation()
            })).on("toggle.xdsoft", (function() {
                O.is(":visible") ? O.trigger("close.xdsoft") : O.trigger("open.xdsoft")
            })).data("input", t), $ = 0, O.data("xdsoft_datetime", C), O.setOptions(x), C.setCurrentTime(B()), t.data("xdsoft_datetimepicker", O).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function() {
                t.is(":disabled") || t.data("xdsoft_datetimepicker").is(":visible") && x.closeOnInputClick || x.openOnFocus && (clearTimeout($), $ = setTimeout((function() {
                    t.is(":disabled") || (N = !0, C.setCurrentTime(B(), !0), x.mask && R(x), O.trigger("open.xdsoft"))
                }), 100))
            })).on("keydown.xdsoft", (function(t) {
                var i, n = t.which;
                return -1 !== [c].indexOf(n) && x.enterLikeTab ? (i = e("input:visible,textarea:visible,button:visible,a:visible"), O.trigger("close.xdsoft"), i.eq(i.index(this) + 1).focus(), !1) : -1 !== [v].indexOf(n) ? (O.trigger("close.xdsoft"), !0) : void 0
            })).on("blur.xdsoft", (function() {
                O.trigger("close.xdsoft")
            }))
        }, a = function(t) {
            var i = t.data("xdsoft_datetimepicker");
            i && (i.data("xdsoft_datetime", null), i.remove(), t.data("xdsoft_datetimepicker", null).off(".xdsoft"), e(x.contentWindow).off("resize.xdsoft"), e([x.contentWindow, x.ownerDocument.body]).off("mousedown.xdsoft touchstart"), t.unmousewheel && t.unmousewheel())
        }, e(x.ownerDocument).off("keydown.xdsoftctrl keyup.xdsoftctrl").off("keydown.xdsoftcmd keyup.xdsoftcmd").on("keydown.xdsoftctrl", (function(e) {
            e.keyCode === d && (S = !0)
            ...
            if (o) {
                if ("string" === e.type(n)) switch (n) {
                    ...
                    case "destroy":
                        ...
                        break;
                    case "reset":
                        this.value = this.defaultValue, this.value && o.data("xdsoft_datetime").isValidDate(i.parseDate(this.value, x.format)) || o.data("changed", !1), o.data("xdsoft_datetime").setCurrentTime(this.value);
                        break;
                    case "validate":
            ...
            "string" !== e.type(n) && (!x.lazyInit || x.open || x.inline ? r(e(this)) : (t = e(this)).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function e() {
...
function(e) {
    ...
    function l(n) {
        var o, r = n || window.event,
            ...
            p = 0,
            m = 0;
        if ((n = e.event.fix(r)).type = "mousewheel", "detail" in r && (f = -1 * r.detail), "wheelDelta" in r && (f = r.wheelDelta), "wheelDeltaY" in r && (f = r.wheelDeltaY), "wheelDeltaX" in r && (h = -1 * r.wheelDeltaX), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (h = -1 * f, f = 0), c = 0 === f ? h : f, "deltaY" in r && (c = f = -1 * r.deltaY), "deltaX" in r && (h = r.deltaX, 0 === f && (c = -1 * h)), 0 !== f || 0 !== h) {
            if (1 === r.deltaMode) {
            ...
            if (o = Math.max(Math.abs(f), Math.abs(h)), (!i || o < i) && u(r, i = o) && (i /= 40), u(r, o) && (c /= 40, h /= 40, f /= 40), c = Math[1 <= c ? "floor" : "ceil"](c / i), h = Math[1 <= h ? "floor" : "ceil"](h / i), f = Math[1 <= f ? "floor" : "ceil"](f / i), a.settings.normalizeOffset && this.getBoundingClientRect) {
                var y = this.getBoundingClientRect();
                p = n.clientX - y.left, m = n.clientY - y.top
            }
            return n.deltaX = h, n.deltaY = f, n.deltaFactor = i, n.offsetX = p, n.offsetY = m, n.deltaMode = 0, l.unshift(n, c, h, f), t && clearTimeout(t), t = setTimeout(d, 200), (e.event.dispatch || e.event.handle).apply(this, l)
        }
    }
...
function(e) {
    ...
    v.prototype = {
        ...
        open: function(i) {
            ...
            if (!t.isOpen) {
                ...
                k("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (_(d, (function(e, t, i, n) {
        ...
        updateItemHTML: function() {
            ...
            t.appendContent(r, n), i.preloaded = !0, k(c, i), o = i.type, t.container.prepend(t.contentContainer), k("AfterChange")
        },
        ...
        _parseMarkup: function(t, i, n) {
            var o;
            n.data && (i = e.extend(n.data, i)), k(d, [t, i, n]), e.each(i, (function(i, n) {
            ...
            getInline: function(i, n) {
                if (E(), i.src) {
                    ...
                    if (s.length) {
                        ...
                        r && r.tagName && (C || (x = o.hiddenClass, C = w(x), x = "mfp-" + x), D = s.after(C).detach().removeClass(x)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(A), M = t.st.ajax.cursor, _(a + "." + A, L), _("BeforeChange." + A, L)
            },
            getAjax: function(i) {
                ...
                var n = e.extend({
                    ...
                    success: function(n, o, s) {
                        ...
                        k("ParseAjax", r), t.appendContent(e(r.data), A), i.finished = !0, I(), t._setFocus(), setTimeout((function() {
                            t.wrap.addClass(p)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var i = t.st.image,
                    n = ".image";
                t.types.push("image"), _(u + n, (function() {
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var i = t.st.gallery,
                    o = ".mfp-gallery";
                return t.direction = !0, !(!i || !i.enabled) && (s += " mfp-gallery", _(u + o, (function() {
...
! function(e, t) {
    ...
    var r, a, l = function() {
        ...
        c = window.getComputedStyle || function(e) {
            var t = /(\-([a-z]){1})/g;
            return {
        ...
        h = function() {
            function e() {
                ...
                i(this, e), this.defaults = {
                    ...
                    return e
                }(t, this.defaults), null != t.scrollContainer && (this.config.scrollContainer = document.querySelector(t.scrollContainer)), this.animationNameCache = new d, this.wowEvent = function(e) {
            ...
            return l(e, [{
                ...
                key: "vendorCSS",
                value: function(e, t) {
                    for (var i = c(e), n = i.getPropertyCSSValue(t), o = 0; o < this.vendors.length; o++) {
